...
config :good_deeds,
  ecto_repos: [GoodDeeds.Repo]

# Configures the endpoint
config :good_deeds, GoodDeedsWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: GoodDeedsWeb.ErrorView, accepts: ~w(html json), layout: false],
...
config :good_deeds, GoodDeeds.Mailer, adapter: Swoosh.Adapters.Local
